...
public class ErrorRoute {
    ...
    public void handleForbidden(Exception exception, Request request, Response response) {
        prepareResponse(response, HttpServletResponse.SC_FORBIDDEN, "Forbidden", exception);
    }
